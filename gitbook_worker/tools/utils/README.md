...
```python
from gitbook_worker.tools.utils import run
...
```bash
python -m gitbook_worker.tools.utils.python_workspace_runner \
  --workspace .github \
...
```python
from gitbook_worker.tools.utils.content_discovery import discover_content
