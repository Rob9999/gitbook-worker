...
from gitbook_worker.tools.utils.smart_publish_target import (
    PublishTarget,
...
try:
    from gitbook_worker.tools.publishing import publisher as legacy_publisher
except ImportError:
    ...
    def build_target(self, target: PublishTarget) -> BuildResult:
        ...
        try:
            ...
            if target.book_config and (
                ...
                from gitbook_worker.tools.publishing.gitbook_style import SummaryContext
            ...
            if target.pdf_options:
                from gitbook_worker.tools.publishing.publisher import EmojiOptions
