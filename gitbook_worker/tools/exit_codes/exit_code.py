...
_EXIT_CODES: tuple[ExitCodeInfo, ...] = (
    ...
    ExitCodeInfo(
        code=45,
        component="editorial_metrics|editorial_acceptance",
        summary="Redaktionelle Abnahme enthält harte Findings",
        healing="Dossier prüfen, Findings beheben oder Restrisiko bewusst dokumentieren.",
        trigger="Mindestens ein Finding mit severity=fail oder blockierende Warnungen im Profil",
    ),
    ExitCodeInfo(
        code=46,
        component="editorial_metrics|editorial_acceptance",
        summary="Redaktionelle Abnahme blockiert durch fehlende Artefakte",
        healing="PDF/Markdown/Report-Artefakte erzeugen oder Pfade im Profil korrigieren.",
        trigger="Mindestens ein Finding mit severity=blocked",
    ),
    ExitCodeInfo(
        code=47,
        component="editorial_acceptance",
        summary="Metrikreport konnte nicht gelesen werden",
        healing="JSON-Reportpfad und JSON-Syntax prüfen; Metriklauf ggf. wiederholen.",
        trigger="Reportdatei fehlt, ist nicht lesbar oder enthält kein JSON-Objekt",
    ),
    ExitCodeInfo(
        code=48,
        component="editorial_metrics|editorial_acceptance",
        summary="Redaktionelles Abnahmeprofil ist ungültig",
        healing="Profilnamen, profiles-Mapping und YAML-Syntax prüfen.",
        trigger="Profil nicht gefunden oder Profilkonfiguration ungueltig",
    ),
    ExitCodeInfo(
        code=2,
        component="publisher",
