...
Nutzung (mind. EIN Kriterium angeben):
  python gitbook_worker/tools/publishing/reset-publish-flag.py --path documents
  python gitbook_worker/tools/publishing/reset-publish-flag.py --out sphere-space.pdf
  python gitbook_worker/tools/publishing/reset-publish-flag.py --index 0
