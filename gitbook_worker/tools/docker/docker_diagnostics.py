...
Usage:
    python -m gitbook_worker.tools.docker.docker_diagnostics capture-before
    # Run Docker container
    python -m gitbook_worker.tools.docker.docker_diagnostics capture-after
    python -m gitbook_worker.tools.docker.docker_diagnostics analyze
...
def main() -> int:
    ...
    if args.command == "capture-before":
        ...
        print("Then run: python -m gitbook_worker.tools.docker.docker_diagnostics capture-after")
        return 0
        ...
        print("Now run: python -m gitbook_worker.tools.docker.docker_diagnostics analyze")
        return 0
