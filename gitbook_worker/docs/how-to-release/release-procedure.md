...
2. **Local Orchestrator Runs**
   ...
   * If LaTeX debug logs are retained, include them in the gate to fail on missing-glyph signals. Directory inputs use the newest log set below that directory:
