...
fonts:
  CJK:
    ...
    paths:
      ...
      - "gitbook_worker/tools/publishing/fonts/.../erda-ccby-cjk.ttf"  # Fallback 2
```
...
```bash
pytest gitbook_worker/tests/test_font_config.py -v
```
...
**Solutions:**
1. Ensure `sys.path` includes `gitbook_worker`
2. Check file exists: `gitbook_worker/tools/publishing/font_config.py`
