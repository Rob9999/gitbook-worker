...
- **[Emoji in headings – Header samples](#md-examples-emoji-headings)**: Regression test for emojis in H1/H2/H3 headings, including ZWJ/VS16/flags.
...
| --- | --- | --- | --- | --- |
| Serif/Sans/Mono | DejaVu Serif · DejaVu Sans · DejaVu Sans Mono (v2.37) | Bitstream Vera License + public-domain additions | `gitbook\_worker/defaults/fonts.yml` · `publish/ATTRIBUTION.md` | Latin, Greek, Cyrillic, plus technical symbols for tables and code |
