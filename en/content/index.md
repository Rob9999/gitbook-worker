...
- [Templates for multilingual text](./templates/multilingual-neutral-text.md)
- [Appendix A – Data sources](./appendices/appendix-a.md)
...
![Neutral shapes](.gitbook/assets/neutral-grid.svg)
