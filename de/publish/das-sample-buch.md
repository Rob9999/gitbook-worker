...
## Sehr lange Texte - mindestens 10 Zeilen

Diese synthetischen Abschnitte dienen der manuellen PDF-Sichtprüfung. Sie sind anonymisiert, enthalten keine Kundentexte und decken die drei ERDA-Fontgruppen aus `fonts.yml` ab.

### ERDA CC-BY CJK

Zuordnung der zehn Langzeilen: 🇹🇼 ZH-Hant - Traditionelles Chinesisch (Zeilen 1-4, 9-10), 🇯🇵 JA - Japanisch (Zeilen 5-6), 🇰🇷 KO - Koreanisch (Zeilen 7-8).
...
1. हिन्दी परीक्षण पंक्ति एक बहुत लंबी है और इसमें PDF, ERDA, AI तथा संस्करण 2.4.0 जैसे लैटिन अंश हैं ताकि देवनागरी आकार और पंक्ति-विराम देखे जा सकें।
2. हिन्दी परीक्षण पंक्ति दो दस्तावेज़, स्रोत, तालिका, टिप्पणी, अनुक्रमणिका, प्रकाशन और समीक्षा जैसे तटस्थ शब्दों को जोड़ती है ताकि पाठ पर्याप्त लंबा रहे।
3. देवनागरी परीक्षण पंक्ति तीन में प्रकाशन मार्ग, फ़ॉन्ट कैश, लाइसेंस फ़ाइल, सामग्री सूची, संदर्भ जाँच और दृश्य निरीक्षण जैसे तटस्थ शब्द रखे गए हैं।
4. देवनागरी परीक्षण पंक्ति चार लंबे संयुक्ताक्षरों, मात्रा चिह्नों, पूर्ण विराम, अंकों 12345 और ERDA PDF QA जैसे छोटे लैटिन समूहों को साथ दिखाती है।
5. देवनागरी परीक्षण पंक्ति पाँच यह देखती है कि अनुच्छेद लंबा होने पर भी अक्षर स्पष्ट रहें, चिह्न अलग न टूटें और पंक्ति की ऊँचाई संतुलित दिखे।
6. देवनागरी परीक्षण पंक्ति छह में समीक्षा, सुधार, प्रकाशन, संग्रह, मानचित्र, तालिका, अनुक्रमणिका और टिप्पणी जैसे शब्द एक विस्तृत वाक्य बनाते हैं।
7. देवनागरी परीक्षण पंक्ति सात फ़ॉलबैक शृंखला, मुख्य फ़ॉन्ट, सहायक फ़ॉन्ट, PDF निर्यात और हस्तचालित दृष्टि परीक्षण को एक साथ जाँचती है।
8. देवनागरी परीक्षण पंक्ति आठ में शांत, सार्वजनिक, निरपेक्ष और पुनरुत्पाद्य सामग्री है, ताकि किसी वास्तविक ग्राहक पाठ का प्रयोग न हो।
9. देवनागरी परीक्षण पंक्ति नौ लम्बे पाठ, छोटे शब्द, विराम चिह्न, कोष्ठक (परीक्षण), द्विबिंदु: विवरण और अर्धविराम; विस्तार को मिलाती है।
10. देवनागरी परीक्षण पंक्ति दस इस समूह को समाप्त करती है और ERDA CC-BY Indic फ़ॉन्ट के दृश्य उपयोग को पर्याप्त लंबाई में दिखाती है।

### ERDA CC-BY Ethiopic

1. አማርኛ የረጅም ጽሑፍ ሙከራ መስመር አንድ ሰነድ፣ ስሪት፣ ምንጭ፣ ሰንጠረዥ፣ PDF፣ ERDA እና AI ቃላትን በአንድ ረጅም አረፍተ ነገር ያቀርባል።
2. አማርኛ የረጅም ጽሑፍ ሙከራ መስመር ሁለት የፊደል መተካት፣ የመስመር ስብራት፣ የገጽ አቀማመጥ እና የምልክት ርቀት ለማየት ይረዳል።
3. አማርኛ መስመር ሶስት የህትመት ሂደትን፣ የፈቃድ መረጃን፣ የምርመራ ማስታወሻን እና የማውጫ አገናኝን በተራ ያሳያል።
4. አማርኛ መስመር አራት በጽሑፍ መካከል Latin terms like workflow, release, QA and checksum በመጨመር የፊደል መቀያየርን ይፈትሻል።
5. ትግርኛ የረጅም ጽሑፍ መስመር ሓሙሽተ ሰነድ፣ ምንጪ፣ ፍቓድ፣ PDF፣ ERDA እና AI ቃላት ብሓደ ነዊሕ ሓሳብ ይምልከት።
6. ትግርኛ መስመር ሽዱሽተ ፊደላት፣ ምልክታት፣ ክፍተት፣ መስመር ምቁራጽን የገጽ ኣቀማመጥን ንምርኣይ ዝተዳለወ እዩ።
7. አማርኛ መስመር ሰባት በረጅም ገጽታ ውስጥ የተመሳሳይ ፊደሎች እንዳይጠበቁ እና የቃላት ክፍተት እንዲታይ ተዘጋጅቷል።
8. አማርኛ መስመር ስምንት የተለያዩ ምልክቶችን፣ ቁጥሮችን 12345፣ ስሪት 2.4.0 እና ቀላል የሰነድ ቃላትን ያጣምራል።
9. ትግርኛ መስመር ትሽዓተ ነዊሕ ዓረፍተ ነገር ብምጥቃም ቅርጺ ፊደል፣ ክብደት ፊደልን ርቀት መስመርን ንምርመራ ይጠቅም።
10. አማርኛ መስመር አስር የዚህን ክፍል ይዘጋል እና በPDF ውስጥ የERDA Ethiopic ፊደል መታየትን በቂ ርዝመት ላይ ያረጋግጣል።
