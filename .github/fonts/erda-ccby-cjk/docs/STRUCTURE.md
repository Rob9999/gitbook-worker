...
history:
  - version: 1.4.0
    date: 2026-05-07
    description: Updated versioning conventions for ERDA font-family v1.4.1.
  - version: 1.3.0
    date: 2026-05-07
...
### Versionierung
- Font-Family-Version: `1.4.1` in `generator/font_version.py`
- OpenType-Version: `Version 1.4.1+YYYYMMDD.HHMMSS` (SemVer + Buildtimestamp)
